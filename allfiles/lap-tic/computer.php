...
$sql = "INSERT INTO Computer(ComputerID , ComputerType, ComputerName, ComputerDescr, RAM, ComputerPrice, ComputerBrand)
VALUES ('".$comid."','".$comtype."', '".$comname."','".$comdescription."', '".$comram."', '".$comprice."', '".$combrand."')";
