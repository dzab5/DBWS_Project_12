...
<form  method="post" >
	<h2> Enter Maximum price for Computer </h2>
	<input type="text"  name="search" placeholder="max price "> <br><br>
...
if ($search != '')
{
  ...
  $sql = "SELECT * FROM Computer WHERE $search >= ComputerPrice";
  ...
  // output data of each row
    echo "You can buy these computers for lower than this price <br> results of: "; 
    echo $search;
    echo "<br><br>" ;
